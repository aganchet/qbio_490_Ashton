...
Fill out a description of the rows/columns of our data frames. You can use this as a cheat sheet moving forward.
  ~ colData
        - Rows: [Patients by TCGA barcode]
        - Columns: [Clinical Data]
  ~ rowRanges@elementMetadata
        - Rows: [Null but should be genes]
        - Columns: [info on genes]
  ~ unstranded (in assays)
        - Rows: [Null but should be genes]
        - Columns: [Null but should be patients]
...
#This is the raw data for genes and patients. col data and rowranges expand upon these.
...
rna_mask <- rowSums(rna_counts) >= 1000
filtered_rna_counts <- rna_counts[rna_mask, ]
...
```{r}
results$gene_name = results$gene_name <- rna_genes[rownames(results), "gene_name"]
```
...
top-right genes: significant up regulation
bottom-right genes: non significant down regulation
top-left genes: signficant down regualtion
bottom-left genes: non significant down regulation
top-middle genes: significant minor differences in regulation
bottom-middle genes: non significant minor differences in regulation
